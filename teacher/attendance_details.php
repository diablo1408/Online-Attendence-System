        ...
        <div class="pd-30 pd-sm-20 bg-gray-200 bd-2  ">
            <div class="row row-xs align-items-center mg-b-20">
                ...
                <div class="col-md-8 mg-t-5 mg-md-t-0">
                    <input form="form1" type="text" class="form-control" placeholder="Enter Academic Year"
            ...
            <div class="row row-xs align-items-center mg-b-20">
                <div class="col-md-4">
                    <label class="form-label mg-b-0 font-weight-bold" style="font-size:medium;">Section For
                        Practical</label>
                </div><!-- col -->
                <div class="col-md-8 mg-t-5 mg-md-t-0">
            ...
            <div class="row row-xs align-items-center mg-b-20">
                <div class="col-md-4">
                    <label class="form-label mg-b-0 font-weight-bold" style="font-size:medium;">Lecture Date</label>
                </div><!-- col -->
                <div class="col-md-8 mg-t-5 mg-md-t-0">
